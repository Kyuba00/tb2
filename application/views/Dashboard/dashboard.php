                ...
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h5 mb-0 font-weight-bold text-gray-800">
                            <?php echo $data_penjualan['total']; ?> Barang
                        </div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h5 mb-0 font-weight-bold text-gray-800">
                            <?php echo ($data_penjualan_buku['total'] - $data_pengembalian_buku['total']); ?> Buku
                        </div>
                    </div>
                    <div class="col-auto">
...
<div class="row">
    ...
    <div class="col-xl-8 col-lg-8">
        <div class="card shadow mb-4">
            ...
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 font-weight-bold text-primary">Rekap Penjualan Buku</h6>
            </div>
                        ...
                        series: [{
                            ...
                            data: [
                                <?php foreach ($data_grafik as $grafik) : ?> {
                                        ...
                                        y: <?php echo $grafik['total_penjualan']; ?>
                                    },
                                <?php endforeach ?>
                            ]
    ...
    <div class="col-xl-4 col-lg-4">
        <div class="card shadow mb-4">
            <!-- Card Header - Dropdown -->
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 font-weight-bold text-primary">Detail Penjualan Buku</h6>
            </div>
                    ...
                    <tbody>
                        <?php foreach ($data_grafik as $buku) : ?>
                            <tr>
                                ...
                                <td><?php echo $buku['total_penjualan']; ?> x</td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
